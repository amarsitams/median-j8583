...
public class Tag implements Serializable {
	...
	@Column(name="err_queue_name_to_pick", length=2147483647)
	private String errQueueNameToPick;

	@Column(name="err_queue_name_to_send", length=2147483647)
	...
	@Column(name="req_queue_name_to_pick", length=2147483647)
	private String reqQueueNameToPick;

	@Column(name="req_queue_name_to_send", length=2147483647)
	private String reqQueueNameToSend;

	@Column(name="resp_queue_name_to_pick", length=2147483647)
	private String respQueueNameToPick;

	@Column(name="resp_queue_name_to_send", length=2147483647)
