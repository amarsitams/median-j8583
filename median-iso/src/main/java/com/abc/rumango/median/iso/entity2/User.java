...
public class User implements Serializable {
	...
	@Column(name="current_sign_in_ip", length=2147483647)
	...
	@Column(name="encrypted_password", nullable=false, length=2147483647)
	...
	@Column(name="last_sign_in_ip", length=2147483647)
	...
	@Column(name="notification_emails", length=2147483647)
	private String notificationEmails;

	@Column(name="notification_mobiles", length=2147483647)
	...
	@Column(name="reset_password_token", length=2147483647)
	...
	@Column(name="unlock_token", length=2147483647)
	private String unlockToken;

	@Column(name="updated_at", nullable=false)
	private Timestamp updatedAt;

	@Column(name="user_id", length=2147483647)
