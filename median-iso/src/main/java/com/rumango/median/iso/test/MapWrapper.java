...
public class MapWrapper {
	...
	/**
	 * <p>
	 * Funny fact: due to type erasure, this method may return List<Element> instead
	 * of List<JAXBElement<String>> in the end;
	 * </p>
	 ...
	 * {{@link #addEntry(String, String)} when this <code>MapWrapper</code> instance
	 * is created by yourself (instead of through unmarshalling).
	 * </p>
	 * 
	 * @param key   map key
